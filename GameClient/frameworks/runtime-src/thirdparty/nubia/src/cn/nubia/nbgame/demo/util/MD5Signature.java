...
public class MD5Signature {
     ...
     * 生成签名，此过程建议在服务端调用
     */
    public static String doSign(String orderId, String productName, String number, String amount, String uid, String timeStamp,String product_des) {
        String sign = null;
        try {
            ...
            parameterMap.put("product_des", product_des);
