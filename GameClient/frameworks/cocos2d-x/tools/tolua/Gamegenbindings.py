...
def main():
    ...
    try:
        ...
        cmd_args = {'IGamePlatformSystem.ini' : ('IGamePlatformSystem', 'lua_IGamePlatformSystem_auto'), \
                    'IDeviceSystem.ini' : ('IDeviceSystem', 'lua_IDeviceSystem_auto'), \
                    'IGameSocketSystem.ini' : ('IGameSocketSystem', 'lua_IGameSocketSystem_auto'), \
                    }
        target = 'lua'
